...
Функция Синхронизировать() Экспорт
	...
	Пока ПродолжатьСинхронизацию Цикл
		...
		ПродолжатьСинхронизацию = ПродолжатьСинхронизацию И ВыгрузитьДанные(СоединениеИПараметры);
	КонецЦикла;
...
Функция ОбновитьШтрихкоды(Данные, Обновлять = Истина)
