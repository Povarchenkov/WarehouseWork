...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ТаблицаПроверки.Колонки.Добавить("Ячейка");
	...
	ТаблицаПроверки.Свернуть("Номенклатура, Ячейка, Упаковка", "Количество, КоличествоВыполнено");
	...
	КонецЕсли;		
	ТекущийОбъект.Комментарий = ТекущийОбъект.Комментарий + СтрокаОшибки;
...
Процедура ПерезаполнитьКоличествоШтук()
	...
	Для Каждого ТекСтрока Из Объект.ТоварыОтбор Цикл 
		ТекСтрока.КоличествоШтук = ТекСтрока.Количество * ТекСтрока.Упаковка.Числитель/ТекСтрока.Упаковка.Знаменатель;	
